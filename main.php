...
<form method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>">
    <label for="string1">Слово 1:</label>
    <input type="text" name="string1"><br>
    <label for="string2">Слово 2:</label>
    <input type="text" name="string2"><br>
    <label for="string3">Слово 3:</label>
...
// Выводим результаты
echo "Слово 1: $string1<br>";
echo "Слово 2: $string2<br>";
echo "Слово 3: $string3<br>";
echo "<br>";

if (empty($numbers)) {
    if (count($uniqueChars) > 10){
        echo "Число символов, являющихся различными больше 10 - результат невычисляем.";
    }
    else{
        echo "Отсутствуют подходящие комбинации.";
    }

} else {
    echo "Сумма двух чисел равна третьему для следующих комбинаций:<br>";
